        ...
        manifests / "methods.yaml",
        {
            ...
            "required": [
                ...
                },
                {
                    ...
                    "native_environment": "egoallo; JAX CUDA with CPU callback backend",
                    "integration_role": "canonical LAFAN benchmark port of the published retargeter; not bare PyRoki",
                    "gate_status": "completed",
                    "required_arguments": {"target_raw_frames": 450},
                    "official_trajectory_contract": {
                        "operation": "trim_or_pad",
                        "duration_s": 15,
                        "fps": 30,
                        "frames": 450,
                        "documentation": "https://nvlabs.github.io/ProtoMotions/tutorials/workflows/retargeting_pyroki.html",
                    },
                    "full_source_coverage_ratio": 0.75,
                    "required_gates": [
                        "canonical_g1_fk_and_joint_limit_audit",
                        "450_frame_official_contract_output",
                        "shared_prefix_0_450_quality_comparison",
                    ],
                },
            ],
